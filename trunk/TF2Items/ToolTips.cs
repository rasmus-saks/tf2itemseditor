...
namespace TF2Items
{
    public class ToolTips
    {
        public static string[,] MArrItemToolTips = {
                                        ...
                                        {"damage penalty", "Decreases the weapon's damage by a percentage."},
                                        {"damage bonus", "Increases the weapon's damage by a percentage."},
                                        ...
                                        {"sniper no headshots", "Disables the ability to headshot. Applies to Sniper Rifles and Huntsmen, but unconfirmed for a reflected arrow. Currently an unused ability."},
                                        ...
                                        {"dmg taken from blast increased", "Increases the damage you take from explosions on a percentage. Currently an unused ability."},
                                        ...
                                        {"minigun spinup time increased", "Increases the spin-up time for the Minigun by a percentage. Only applies to Miniguns. Unused."},
                                        ...
                                        {"Construction rate increased", "Increases the construction rate of the Wrench by percentage. Only applies to Wrenches. Unused."},
                                        ...
                                        {"mod wrench builds minisentry", "Disables the ability to upgrade buildings. Currently an unused attribute, since the weapon that has this (P.D.Q.) is scrapped."},
                                        ...
                                        {"sticky air burst mode", "The stickybombs burst when it touches ANYTHING. However, it doesn't work. Currently an unused attribute."},
                                        ...
                                        {"lunchbox adds minicrits", "Gives you the ability to give and take Mini-Crit damage. Only applies to the Crit-a-Cola and Pepsi."},
                                        ...
                                        {"bleeding duration", "Makes the opponent bleed on hit. The duration is based on the value, on units."},
                                        ...
                                        {"aiming movespeed decreased", "Aiming movement speed is decreased."},
