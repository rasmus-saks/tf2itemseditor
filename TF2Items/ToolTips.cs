...
namespace TF2Items
{
	public class ToolTips
	{
		public static string[,] MArrItemToolTips = {	   
                                        ...
                                        {"air dash count", "Grants triple jump."},
                                        ...
                                        {"maxammo grenades1 increased", "Unknown"},
                                        {"override projectile type", "Unknown"},
                                        {"energy weapon no ammo", "Weapon does not require ammo."},
                                        {"energy weapon charged shot", "Alt-Fire: Charged shot that minicrits players and disables buildings for 4 sec."},
                                        ...
                                        {"no crit boost", "Weapon cannot be crit bosted"},
                                        {"centerfire projectile", "Shoots projectiles from your crosshair"},
                                        {"kill eater score type", "Unknown"},
                                        {"kill eater score type 2", "Unknown"},
                                        {"kill eater 2", "Unknown"},
                                        {"has pipboy interface", "Gives the engineer's PDA a Pip-Boy style interface"},
                                        {"sapper kills collect crits", "Gives one guaranteed critical hit for each building destroyed with your sapper attached"},
                                        {"sniper only fire zoomed", "Cannot fire unless zoomed"},
                                        {"mod ammo per shot", "Uses n ammo per shot"},
                                        {"add onhit addammo", "On hit: damage dealt is returned as ammo"},
                                        {"electrical airblast DISPLAY ONLY", "On fire: Generates an electrical field that destroys projectiles and does slight damage to players"},
                                        {"mod use metal ammo type", "Uses metal for ammo"},
                                        {"mod max primary clip override", "Unknown"},
                                        ...
                                        {"draw sniper beam when scoped", "Shows a beam when aiming with a sniper rifle"}
									 };
